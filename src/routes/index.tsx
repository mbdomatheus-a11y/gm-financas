...
import { EntrarDialog } from "@/components/EntrarDialog";
...
function LandingPage() {
  ...
  return <main className="min-h-screen bg-background text-foreground">
    <header className="sticky top-0 z-20 border-b bg-background/90 backdrop-blur-md"><div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
      ...
      <nav className="hidden items-center gap-5 text-sm text-muted-foreground md:flex"><a href="#recursos">Recursos</a><a href="#modulos">Módulos</a><Link to="/calculadoras" className="rounded-full bg-primary/10 px-3 py-1 font-medium text-primary transition hover:bg-primary/20">Calculadoras</Link><Link to="/links-temporarios" className="rounded-full bg-primary/10 px-3 py-1 font-medium text-primary transition hover:bg-primary/20">Link temporário</Link><a href="#demonstracao">Demonstração</a><a href="#precos">Preços</a><LegalDialogs /></nav>
      <EntrarDialog><Button size="sm">Entrar <ArrowRight className="size-4" /></Button></EntrarDialog>
    </div></header>
    <EconomiaTotalBanner />
